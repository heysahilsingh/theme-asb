        ...
        <div className="aqi-meter relative text-white">
            <div className="meter border border-transparent">
                <svg className="-rotate-[1deg] -mt-[6%] -mb-[11%] w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 60">
                    ...
                    <text x="50" y="42" textAnchor="middle" fill="white" className="text-[2.5em] font-black">{props.value}</text>

                    <text x="50" y="49" textAnchor="middle" fill="white" className="text-[0.8em] lg:text-[0.5em] font-medium">AQI</text>
                </svg>
            </div>
        </div>
    );
